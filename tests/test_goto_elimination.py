...
class TestGotoELim(unittest.TestCase):
    ...
    def test_2_1(self):
        ...
        statements["main"] = [
            ...
            parse.If(
                ...
                [
                    ...
                    parse.Let(None, parse.VariableExpression("e"), 2),
                ],
            ),
            parse.End(None),
        ]
        ...
        process = subprocess.call(["rustc", "2_1.rs"], subprocess.PIPE)
        process = subprocess.Popen(["./2_1"], stdout=subprocess.PIPE)
        (program_output, _) = process.communicate()
    ...
    def tearDown(self):
        globs = [u"1_1_bas*", u"1_1_bare_bas*", u"1_2_bas*", u"2_1", u"3_1*"]
        for g in globs:
